...
/* ================ dev components ====================== */
import { WrapperIcon, WeatherWidget } from '@lib';

/* ===================== docs =========================== */
import { TheLogo, SectionDocs, SectionComponent } from '@docs/components';
import { IconTogglerTheme, IconTogglerMenu } from '@docs/icons';
...
<template>
    <TheLogo>
        <template #prepend>
            <IconTogglerMenu @click="menu = true" />
        </template>

        <template #append>
            <IconTogglerTheme :theme="currentTheme" @click="toggleTheme" />
        </template>
    </TheLogo>

    <TheMenu v-model="menu" />
    ...
    <SectionDocs title="Utils List">
        <SectionComponent title="Debounce"> ... </SectionComponent>
        <SectionComponent title="Throttle"> ... </SectionComponent>
    </SectionDocs>
</template>
